...
num_invalido_2 = 'O valor não pode ser maior que 2.'
num_invalido_10 = 'O valor não pode ser maior que 10.'
...
data_invalida = 'A data inserida não pode ser antes da atual.'
